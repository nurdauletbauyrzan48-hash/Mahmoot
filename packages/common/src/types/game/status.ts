import type { Player } from "@mahmoot/common/types/game"
...
export type CommonStatusDataMap = {
  ...
  WAIT: { text: string }
  FINISHED: { subject: string; top: PlayerWithStats[] }
}
...
type ManagerExtraStatus = {
  ...
  SHOW_LEADERBOARD: { oldLeaderboard: PlayerWithStats[]; leaderboard: PlayerWithStats[] }
}
