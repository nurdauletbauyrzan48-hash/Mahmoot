import type {
  ...
  Player,
  QuizzWithId,
} from "@mahmoot/common/types/game"
import type { Status, StatusDataMap } from "@mahmoot/common/types/game/status"
...
export interface ServerToClientEvents {
  ...
  "manager:uploadSuccess": (_quizzId: string) => void
  "manager:uploadError": (_message: string) => void
...
export interface ClientToServerEvents {
  ...
  "manager:uploadQuiz": (_data: { name: string; content: string }) => void
